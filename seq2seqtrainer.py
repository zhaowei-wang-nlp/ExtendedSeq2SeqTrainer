...
class ExtendedSeq2SeqTrainer(Seq2SeqTrainer):
    ...
    def generate(self, test_dataset, max_source_length=None, max_length=None, num_beams=None,
                 num_return_sequences=None, min_length=None, do_sample=None, temperature=None, top_k=None,
                 **kwargs):
    ...
    def generation_loop(self, dataloader, description, ):
        args = self.args
        ...
        for step, inputs in enumerate(dataloader):
            ...
            # Prediction step
            input_ids, logits, scores, labels = self.generation_step(inputs)
    ...
    def generation_step(self, inputs, ):
        ...
        gen_kwargs = {
            ...
            "num_return_sequences": getattr(self, "_num_return_sequences",
                                            self._num_beams if self._num_beams is not None
        ...
        for key in self._kwargs:
            gen_kwargs[key] = self._kwargs[key]
